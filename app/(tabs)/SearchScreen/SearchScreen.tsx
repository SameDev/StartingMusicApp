  ...
  const renderMusicItem = useCallback(
    ({ item }: { item: Music }) => (
      <View
        ...
        onTouchEnd={() => navigation.navigate('MusicPlayer', { song: item as unknown as Music[] })}
      >
        ...
        <TouchableOpacity onPress={() => navigation.navigate('MusicPlayer', { song: item as unknown as Music[] })}>
          <FontAwesome
                name={"play"}
                size={20}
                color="#fff"
